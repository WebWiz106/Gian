...
// import { handleProfilePopup } from "@/utils/profilePopup";
...
export default function RootLayout({
  ...
  const tg = useAppSelector((state: any) => state.toggler.profileToggler);
  console.log(tg);
  const handleProfilePopup = () => {

    dispatch(setProfileToggler(!tg));

  }


  const handleClose = () => {
    dispatch(setProfileToggler(false));
  }
  ...
  return (
    <html lang="en">
      <body onBlur={handleClose} className=" ">
          ...
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start rtl:justify-end">
                ...
                <Link href="https://flowbite.com" className="ms-2 flex md:me-24">
                  <Image
                    width={140}
                    height={100}
                    src={Logo}
              ...
              <div className="flex items-center">
                <div className="ms-3 flex items-center">
                  ...
                  {/* Porfile icon */}
                  {tg && <div
                    className=" absolute top-[40px]  right-8 z-50 my-4 list-none divide-y divide-gray-100 rounded bg-white text-base shadow dark:divide-gray-600 dark:bg-gray-700"
                    id="dropdown-user"
                  >
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">Payments</span>
                  <span className="ms-3 inline-flex self-center rounded-full bg-gray-100 px-2 text-sm font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                    soon
                  </span>
                </Link>
              </li>
              ...
              <li>
                <Link
                  href="/client/dashboard/usermanagement"
                  className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                >
                  <svg
                    className="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                  ...
                  <span className="ms-3 flex-1 whitespace-nowrap">User Management</span>
