          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex w-[65%] flex-col max-md:ml-0 max-md:w-full">
              <div className="flex grow flex-col px-5 max-md:mt-10 max-md:max-w-full max-md:px-0">
                ...
                <input
                  type="text"
                  className="mt-10 bg-transparent   text-base leading-6 tracking-wide    outline-none  max-md:mt-10 max-md:max-w-full"
                ...
                <input type="text"
                  name="linkedin"
                  onChange={handleChange}
                  placeholder="Linkedin" className="mt-14 text-base outline-none bg-transparent leading-6 tracking-wide max-md:max-w-full" />

                <div className="mt-3 h-px shrink-0 bg-zinc-500 max-md:max-w-full" />
                <input type="text" placeholder="Let’s talk about your idea" className="mt-16 outline-none bg-transparent text-base leading-6 tracking-wide    max-md:mt-10 max-md:max-w-full" />
                <div className="mt-3 h-px shrink-0 bg-zinc-500 max-md:max-w-full" />
                ...
                <button onClick={handleSubmit} type="submit" className="mt-10 items-center justify-center whitespace-nowrap bg-blue-700 p-4 text-center text-sm font-medium uppercase leading-6 tracking-wide  text-white max-md:max-w-full max-md:px-5">
                  Submit
                </button>
